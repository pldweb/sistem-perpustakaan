...
<div class="container mt-4">
    ...
    <!-- 01. Content-->
    <h1 class="text-center mb-4">To Do List Sehari-hari</h1>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mb-3">
                <div class="card-body">

                    {{-- Session punya parameter success --}}
                    ...
                    <ul class="list-group mb-4" id="todo-list">
                        ...
                        @foreach ($data as $item)
                            ...
                            <li class="list-group-item collapse" id="collapse-{{ $loop->index }}">
                                ...
                                <form action="{{ route('todo.update',['id'=> $item->id ]) }}" id="" method="POST">
                                    @csrf
                                    @method('put')
                                        ...
                                        <div class="radio px-2">
                                            <label>
                                                <input type="radio" value="1"
                                                       name="is_done" {{ $item->is_done == '1' ? 'checked' : '' }}>
                                                Selesai
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" value="0"
                                                       name="is_done" {{ $item->is_done == '0' ? 'checked' : '' }}>
                                                Belum
                                            </label>
                                        </div>
                                    </div>
