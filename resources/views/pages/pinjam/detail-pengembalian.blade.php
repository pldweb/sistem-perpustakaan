                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12 d-flex">
                                ...
                                <div class="data-field"><span
                                        class="badge badge-primary">{{ $peminjaman->tanggal_pinjam }}</span></div>
                            </div>
                            <div class="mb-3 col-12 d-flex">
                                <label for="" class="form-label" style="width: 250px;">Tanggal Tenggat
                                    Pengembalian</label>
                                <div class="data-field"><span
                                        class="badge badge-danger">{{ \Carbon\Carbon::parse($peminjaman->tanggal_pengembalian)->format('d-m-Y') }}</span>
                                </div>
                            </div>
                            <div class="mb-3 col-12 d-flex">
                                <label for="" class="form-label" style="width: 250px;">Tanggal Pengembalian</label>
                                <div class="data-field"><span
                                        class="badge badge-secondary">{{ $peminjaman->status }}</span></div>
                            </div>
                            <div class="mb-3 col-12 d-flex">
                                ...
                                <div class="data-field w-75">
                                    ...
                                    <form action="{{ route('storePengembalian', $peminjaman->id) }}" method="post">
                                                ...
                                                @foreach($peminjamanBuku as $index => $item)
                                                    <div class="col-6">
                                                        ...
                                                        <select name="books[{{ $index }}][book_id]"
                                                                class="form-select form-control book-select"
                                                                data-index="{{ $index }}" required>
                                                            <option value="{{ $item->buku_id }}"
                                                                    selected>{{ $item->judul_buku }}</option>

                                                        </select>
                                                    </div>
                                                    <div class="col-6">
                                                        <label for="books[{{ $index }}][jumlah]" class="form-label">Jumlah</label>
                                                        <input type="number" name="books[{{ $index }}][jumlah]"
                                                               class="form-control jumlah-buku" min="0" max="3"
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                                onclick="return confirm('Apakah data sudah benar?')">Kembalikan Buku
                                        </button>
                                    </form>
                                </div>
                            </div>
