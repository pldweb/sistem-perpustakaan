                ...
                <div class="card card-round">
                    ...
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('updatePinjam', [$pinjam->tanggal_pinjam, $pinjam->id]) }}" method="post">
                                @csrf
                                @method('put')
                                    ...
                                    <div class="row mb-3 book-row d-flex flex-wrap">
                                        <div class="col-6">
                                            ...
                                            <select name="books[0][book_id]"
                                                    class="form-select form-control book-select" data-index="0"
                                                    required>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="number" name="books[0][jumlah]"
                                                   class="form-control jumlah-buku" min="1" max="3" required
                                                   value="{{ old('books.0.jumlah', $pinjam->jumlah) }}">
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <button type="button" class="btn add-book btn-success mt-4">Tambah Buku
                                            </button>
                                ...
                                <div class="row mt-3">
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="date" name="tanggal_pinjam" class="form-control" required value="{{ old('tanggal_pinjam', $pinjam->tanggal_pinjam) }}">
                                    </div>
                                    <div class="mb-3 col-6">
                                        <label for="tanggal_pengembalian" class="form-label">Tanggal
                                            Pengembalian</label>
                                        <input type="date" name="tanggal_pengembalian" class="form-control" required value="{{ old('tanggal_pengembalian', $pinjam->tanggal_pengembalian) }}">
                                    </div>
                                    <div class="mb-3 col-12">
                                        <label for="catatan" class="">Catatan</label>
                                        <textarea class="form-control" id="comment" name="catatan" cols="3"
                                                  rows="5">{{ old('catatan', $pinjam->catatan) }}</textarea>
                                    </div>
                                </div>

                                <button type="submit" class="btn btn-primary"
                                        onclick="return confirm('Apakah data sudah benar?')">Simpan Data Buku
                                </button>
                            </form>
                        </div>
                    </div>
